          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="relative bg-bg-card border border-border-primary rounded-3xl p-6 md:p-10 lg:p-12 shadow-[0_0_60px_rgba(0,0,0,0.3)]">
                <div className="absolute top-0 right-0 w-20 h-20 md:w-32 md:h-32 bg-gold-primary/10 rounded-full blur-3xl" />
                <div className="absolute bottom-0 left-0 w-24 h-24 md:w-40 md:h-40 bg-blue-accent/5 rounded-full blur-3xl" />
                <div className="relative">
                  <MessageCircle className="w-8 h-8 md:w-12 md:h-12 text-gold-primary/30 mb-4 md:mb-8" />
                  ...
                  <div className="flex items-center gap-3 md:gap-4">
                    <div className="w-10 h-10 md:w-16 md:h-16 bg-bg-secondary border border-border-primary rounded-full flex items-center justify-center text-gold-primary text-lg md:text-xl font-bold">
                      AVS
                    </div>
                    <div>
                      <p className="font-semibold text-sm md:text-base text-text-primary">Apoorv Vikram Singh</p>
                      <p className="text-xs md:text-sm text-text-muted">CEO & Founder</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 max-w-[1600px]">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
              {[
          ...
          >
            {trustPoints.map((point, index) => (
              <motion.div
                ...
                className="flex items-start gap-3 p-4 bg-bg-card border border-border-primary rounded-2xl hover:border-gold-primary/30 hover:shadow-xl transition-all duration-300"
              >
                <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-br from-gold-primary/25 to-gold-deep/15 border border-gold-primary/20 rounded-xl flex items-center justify-center text-gold-primary">
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 max-w-[1600px]">
          ...
          >
            {values.map((value, index) => (
              ...
              >
                <div className="w-12 h-12 md:w-16 md:h-16 bg-bg-secondary border border-border-primary rounded-2xl flex items-center justify-center mx-auto mb-4 md:mb-6 group-hover:border-gold-primary/50 transition-all duration-300">
                  <Check className="w-6 h-6 md:w-8 md:h-8 text-gold-primary" />
                </div>
                <h3 className="text-lg md:text-xl font-semibold text-text-primary mb-2 md:mb-3">{value.title}</h3>
          ...
          >
            {team.map((member, index) => (
              <motion.div
                ...
                className="bg-bg-card border border-border-primary rounded-3xl p-6 md:p-8 text-center hover:border-gold-primary/30 transition-all duration-300"
              >
                <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-gold-primary/30 to-gold-deep/20 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 border border-border-primary">
                  <span className="text-gold-primary font-bold text-xl md:text-2xl lg:text-3xl">{member.initial}</span>
                </div>
                <h3 className="text-lg md:text-xl font-bold text-text-primary mb-2">{member.name}</h3>
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 max-w-[1600px]">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm sm:text-lg md:text-xl text-text-secondary mb-8 md:mb-12 max-w-3xl mx-auto leading-relaxed">
